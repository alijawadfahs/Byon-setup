...
sudo apt-get install kubeadm  || log_print ERROR "kubeadm installation failed!"; exit 1
sudo apt-get install kubectl  || log_print ERROR "kubectl installation failed!"; exit 1
sudo apt-get install kubelet  || log_print ERROR "kubelet installation failed!"; exit 1
